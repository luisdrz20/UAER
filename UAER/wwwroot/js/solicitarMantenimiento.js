...
function loadDataTable() {
    datatable = $('#tblDatos').DataTable({
        "ajax": {
            "url": "/Admin/SolicitarMantenimiento/ObtenerTodos"
        },
        "columns": [
            { "data": "areasS.nombre" },
            { "data": "nombreSolicitante" },
            { "data": "mantenimiento.nombre" },
            {
                "data": "fechaSolicitud",
                ...
                "render": function (data) {
                    return `
                        <div class="text-center">
                            <a href="/Admin/SolicitarMantenimiento/Upsert/${data}" class="btn btn-success text-white" style="cursor:pointer">
                                <i class="bi bi-pencil-square"></i>
                            </a>
                            <a onclick=Delete("/Admin/SolicitarMantenimiento/Delete/${data}") class="btn btn-danger text-white" style="cursor:pointer">
...
function Delete(url) {
    swal({
        title: "Seguro que quieres eliminar la solicitud de Mantenimiento?",
